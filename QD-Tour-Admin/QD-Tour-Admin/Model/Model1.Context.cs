...
namespace QD_Tour_Admin.Model
{
    ...
    public partial class QDTourAdminEntities : DbContext
    {
        public QDTourAdminEntities()
            : base("name=QDTourAdminEntities")
        {
        }
        ...
        public virtual DbSet<Golf_Package_Image> Golf_Package_Image { get; set; }
    }
}
